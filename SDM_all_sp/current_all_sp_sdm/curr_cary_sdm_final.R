...
setwd("/home/fernanda/sdm_p2_test_cluster")

###### dados para Caryothraustes presente ######

occu_cary <- read.csv("Caryothraustes_canadensis_occ.csv", header=T)

bio_curr <- worldclim_global(var='bio', res=0.5, path="/home/fernanda/sdm_p2_test_cluster", download=F)[[c(1,4,10,11,12,15,16,17)]]
...
final_folder <- "/home/fernanda/sdm_p2_test_cluster"
...
#####Rodando o ModleR
sdmdata_1sp <- setup_sdmdata(species_name = "curr_cary",
...
many <- do_many(species_name = "curr_cary",
                predictors = preds_curr,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "curr_cary",
...
ens <- ensemble_model(species_name = "curr_cary",
                      occurrences = occu_cary,
...
save.image('curr_cary_final_sdm_results.RData')
