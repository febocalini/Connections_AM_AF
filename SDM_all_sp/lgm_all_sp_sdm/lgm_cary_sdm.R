...
sdmdata_1sp <- setup_sdmdata(species_name = "lgm_cary",
...
many <- do_many(species_name = "lgm_cary",
                predictors = preds_lgm,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "lgm_cary",
...
ens <- ensemble_model(species_name = "lgm_cary",
                      occurrences = occu_cary,
...
save.image('lgm_cary_final_sdm_results.RData')
