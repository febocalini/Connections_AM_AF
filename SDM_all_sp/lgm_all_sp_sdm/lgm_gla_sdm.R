...
###### Final ModleR glaothraustes ######
setwd("/home/fernanda/lgm_all_sp_sdm_artigo2")

###### dados para glaothraustes lgm ######h
...
sdmdata_1sp <- setup_sdmdata(species_name = "lgm_gla",
...
many <- do_many(species_name = "lgm_gla",
                predictors = preds_lgm,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "lgm_gla",
...
ens <- ensemble_model(species_name = "lgm_gla",
                      occurrences = occu_gla,
...
save.image('lgm_gla_final_sdm_results.RData')
