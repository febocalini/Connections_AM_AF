...
setwd("E:/eems_artigo2/results/eems_artigo2/pic_eems/d200")
library(rEEMSplots)
Sys.setenv(R_GSCMD="C:/Program Files/gs/gs9.53.1/bin/gswin64c.exe")
# Use the provided example or supply the path to your own EEMS run.
picdata_path <- getwd()

eems_results <- file.path(picdata_path, c("output_run1","output_run2","output_run3") )
name_figures <- file.path(picdata_path, "pic_eems_d200pdf")
library("rgdal")
...
setwd("E:/eems_artigo2/results/eems_artigo2/pic_eems/d400")

# Use the provided example or supply the path to your own EEMS run.
picdata_path4 <- getwd()

eems_results4 <- file.path(picdata_path4, c("output_run1","output_run2","output_run3") )
name_figures4 <- file.path(picdata_path4, "pic_eems_d400pdf")
projection_none <- "+proj=longlat +datum=WGS84"
projection_mercator <- "+proj=merc +datum=WGS84"
...
setwd("E:/eems_artigo2/results/eems_artigo2/pic_eems/d600")

# Use the provided example or supply the path to your own EEMS run.
picdata_path6 <- getwd()

eems_results6 <- file.path(picdata_path6, c("output_run1","output_run2","output_run3") )
name_figures6 <- file.path(picdata_path6, "pic_eems_d600pdf")
projection_none <- "+proj=longlat +datum=WGS84"
projection_mercator <- "+proj=merc +datum=WGS84"
...
setwd("D:/eems_artigo2/results/eems_artigo2/pic_eems/d400")
picdata_path <- getwd()
eems_results <- file.path(picdata_path, c("output_run1","output_run2","output_run3") )
name_figures <- file.path(picdata_path, "pic_eems_d400pointsfinal")
coordenadas <- read.table("pic_eems.coord", header=FALSE, sep="\t", dec=".", colClasses="numeric")
