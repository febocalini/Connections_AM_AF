...
###### Final ModleR Picumnus ######
setwd("/home/fernanda/curr_all_sp_sdm_artigo2")

###### dados para Picumnus presente ######
...
#####Rodando o ModleR
sdmdata_1sp <- setup_sdmdata(species_name = "curr_pic",
...
many <- do_many(species_name = "curr_pic",
                predictors = preds_curr,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "curr_pic",
...
ens <- ensemble_model(species_name = "curr_pic",
                      occurrences = occu_pic,
...
save.image('curr_pic_final_sdm_results.RData')
