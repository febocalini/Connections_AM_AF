...
###### Final ModleR Hemithraupis ######
setwd("/home/fernanda/curr_all_sp_sdm_artigo2")

###### dados para Hemithraupis presente ######
...
#####Rodando o ModleR
sdmdata_1sp <- setup_sdmdata(species_name = "curr_hemi",
...
many <- do_many(species_name = "curr_hemi",
                predictors = preds_curr,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "curr_hemi",
...
ens <- ensemble_model(species_name = "curr_hemi",
                      occurrences = occu_hemi,
...
save.image('curr_hemi_final_sdm_results.RData')
