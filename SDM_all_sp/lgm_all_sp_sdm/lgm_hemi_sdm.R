...
###### Final ModleR hemiothraustes ######
setwd("/home/fernanda/lgm_all_sp_sdm_artigo2")

###### dados para hemiothraustes lgm ######
...
sdmdata_1sp <- setup_sdmdata(species_name = "lgm_hemi",
...
many <- do_many(species_name = "lgm_hemi",
                predictors = preds_lgm,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "lgm_hemi",
...
ens <- ensemble_model(species_name = "lgm_hemi",
                      occurrences = occu_hemi,
...
save.image('lgm_hemi_final_sdm_results.RData')
