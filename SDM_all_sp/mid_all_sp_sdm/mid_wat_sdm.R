...
sdmdata_1sp <- setup_sdmdata(species_name = "mid_wat",
...
many <- do_many(species_name = "mid_wat",
                predictors = preds_mid,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "mid_wat",
...
ens <- ensemble_model(species_name = "mid_wat",
                      occurrences = occu_wat,
...
save.image('mid_wat_final_sdm_results.RData')
