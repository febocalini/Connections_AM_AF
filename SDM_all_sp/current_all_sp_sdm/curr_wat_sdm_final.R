...
###### Final ModleR T. watertonii ######
setwd("/home/fernanda/curr_all_sp_sdm_artigo2")

###### dados para T. watertonii presente ######
...
#####Rodando o ModleR
sdmdata_1sp <- setup_sdmdata(species_name = "curr_wat",
...
many <- do_many(species_name = "curr_wat",
                predictors = preds_curr,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "curr_wat",
...
ens <- ensemble_model(species_name = "curr_wat",
                      occurrences = occu_wat,
...
save.image('curr_wat_final_sdm_results.RData')
