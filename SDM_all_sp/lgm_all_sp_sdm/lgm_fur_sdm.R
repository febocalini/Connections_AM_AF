...
###### Final ModleR furothraustes ######
setwd("/home/fernanda/lgm_all_sp_sdm_artigo2")

###### dados para furothraustes lgm ######
...
sdmdata_1sp <- setup_sdmdata(species_name = "lgm_fur",
...
many <- do_many(species_name = "lgm_fur",
                predictors = preds_lgm,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "lgm_fur",
...
ens <- ensemble_model(species_name = "lgm_fur",
                      occurrences = occu_fur,
...
save.image('lgm_fur_final_sdm_results.RData')
