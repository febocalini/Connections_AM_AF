...
###### Final ModleR T. glaucopis ######
setwd("/home/fernanda/curr_all_sp_sdm_artigo2")

###### dados para T. glacata presente ######
...
#####Rodando o ModleR
sdmdata_1sp <- setup_sdmdata(species_name = "curr_gla",
...
many <- do_many(species_name = "curr_gla",
                predictors = preds_curr,
                models_dir = final_folder,
                png_partitions = TRUE,
                write_bin_cut = FALSE,
...
final_model(species_name = "curr_gla",
...
ens <- ensemble_model(species_name = "curr_gla",
                      occurrences = occu_gla,
...
save.image('curr_gla_final_sdm_results.RData')
